...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 20px;">
  ...
  <img src="/images/People/safeeq-khan.jpg" alt="Mohammad Safeeq"
       style="width: 140px; height: 140px; object-fit: cover; border-radius: 50%; flex-shrink: 0;">

  <div>
    <p>Dr. <a href="https://ecohydrology.ucmerced.edu/" target="_blank">Mohammad Safeeq</a><br>Associate Professor in CEE Department at University of California Merced.<br>
    - VIC hydrologic modeling <br>
    - Snowpack and snowmelt processes <br>
    - Drought impacts on water resources <br>
    - Wildfire effects on forests and watershed health <br>
    </p> 
